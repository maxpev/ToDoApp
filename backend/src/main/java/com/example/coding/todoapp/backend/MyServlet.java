...
package com.example.coding.todoapp.backend;
...
public class MyServlet extends HttpServlet {
    static Logger Log = Logger.getLogger("com.example.coding.todoapp.backend.MyServlet");
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        FirebaseOptions options = new FirebaseOptions.Builder()
                .setServiceAccount(getServletContext().getResourceAsStream("/WEB-INF/ToDoFirebaseProject-5f6ec6e65719.json"))
                .setDatabaseUrl("https://todofirebaseproject-98070.firebaseio.com/")
                .build();
        ...
        ref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                try {
                    ...
                    msg.setFrom(new InternetAddress("reminder@todofirebaseproject-98070.appspotmail.com",
                            "Todo Reminder"));
                    msg.addRecipient(Message.RecipientType.TO,
                            new InternetAddress("firebase5850@gmail.com", "Recipient"));
